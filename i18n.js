window.I18N = {
  ...
  ru: {
    ...
    rooms: {
      ...
      standard_desc: 'Уютный номер 27 м² с удобной кроватью, рабочей зоной и всем необходимым для комфортного проживания. Шведский стол на завтрак включён. Номер рассчитан на одного гостя; двухместное размещение возможно за дополнительную плату 10 000 ₸ в сутки.',
      polulux_desc: 'Просторный полулюкс 48 м² с гостиной зоной и улучшенной отделкой. Идеален для деловых поездок и продолжительного пребывания. Номер рассчитан на одного гостя; двухместное размещение возможно за дополнительную плату 10 000 ₸ в сутки.',
  ...
  kz: {
    ...
    rooms: {
      ...
      lux_name: 'Люкс',
      apartments_name: 'Апартамент',
      standard_desc: '27 м² жайлы нөмір, ыңғайлы төсек, жұмыс аймағы және жайлы тұруға қажетті бәрі. Швед үстелі таңғы ас құнға кіреді. Нөмір бір қонаққа арналған; екі орындық орналастыру тәулігіне 10 000 ₸ қосымша ақыға мүмкін.',
      polulux_desc: '48 м² кең жартылай люкс, қонақ бөлмесімен және жоғары сападағы әрлеумен. Іссапарлар мен ұзақ мерзімді тұруға ыңғайлы. Нөмір бір қонаққа арналған; екі орындық орналастыру тәулігіне 10 000 ₸ қосымша ақыға мүмкін.',
  ...
  en: {
    ...
    rooms: {
      ...
      standard_desc: 'A cosy 27 m² room with a comfortable bed, a work area and everything for a pleasant stay. Buffet breakfast included. The room is intended for one guest; double occupancy is available for an extra 10,000 ₸ per night.',
      polulux_desc: 'A spacious 48 m² Junior Suite with a sitting area and enhanced finishes. Ideal for business trips and longer stays. The room is intended for one guest; double occupancy is available for an extra 10,000 ₸ per night.',
