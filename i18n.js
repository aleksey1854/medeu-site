...
window.I18N = {
  ...
  ru: {
    ...
    about: {
      ...
      title: 'Добро пожаловать в комплекс Медеу',
      p1: 'Гостиничный комплекс «Медеу» — четырёхзвёздная гостиница из 58 номеров шести категорий, идеально расположенная в самом центре Костаная. Мы рады вновь приветствовать Вас в нашем комплексе.',
    ...
    rooms: {
      ...
      standard_desc: 'Уютный номер 27 м² с удобной кроватью, рабочей зоной и всем необходимым для комфортного проживания. Шведский стол на завтрак включён.',
      polulux_desc: 'Просторный полулюкс 48 м² с гостиной зоной и улучшенной отделкой. Идеален для деловых поездок и продолжительного пребывания.',
    ...
    footer: {
      ...
      copy: 'Гостиничный комплекс «Медеу»',
  ...
  kz: {
    ...
    about: {
      ...
      title: 'Медеу кешеніне қош келдіңіздер',
      p1: '«Медеу» қонақ үй кешені — алты санаттағы 58 нөмірден тұратын төрт жұлдызды қонақ үй, Қостанайдың дәл орталығында орналасқан. Сіздерді кешенімізде қайтадан қарсы алуға қуаныштымыз.',
    ...
    rooms: {
      ...
      lux_name: 'Люкс',
      apartments_name: 'Апартамент',
      standard_desc: '27 м² жайлы нөмір, ыңғайлы төсек, жұмыс аймағы және жайлы тұруға қажетті бәрі. Швед үстелі таңғы ас құнға кіреді.',
      polulux_desc: '48 м² кең жартылай люкс, қонақ бөлмесімен және жоғары сападағы әрлеумен. Іссапарлар мен ұзақ мерзімді тұруға ыңғайлы.',
  ...
  en: {
    ...
    rooms: {
      ...
      standard_desc: 'A cosy 27 m² room with a comfortable bed, a work area and everything for a pleasant stay. Buffet breakfast included.',
      polulux_desc: 'A spacious 48 m² Junior Suite with a sitting area and enhanced finishes. Ideal for business trips and longer stays.',
